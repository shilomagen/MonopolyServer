...
public class InitiateGame {
    ...
    private LinkedList<Card> supriseCards;
    private LinkedList<Card> warrantCards;

    public void xmlLoad() throws SAXException {
    ...
    public LinkedList<CellData> getMonopolyBoard(Monopoly monopoly) {
    ...
    public LinkedList<Card> createSupriseCards(Monopoly monopoly) {
    ...
    public LinkedList<Card> createWarrantCards(Monopoly monopoly) {
    ...
    public LinkedList<CountryGame> createCountries(Monopoly monopoly) {
    ...
    public LinkedList<City> createCities(Monopoly.Assets.Countries.Country country) {
    ...
    public LinkedList<Transportation> createTransportation(Monopoly monopoly) {
    ...
    public LinkedList<Utility> createUtility(Monopoly monopoly) {
    ...
    public LinkedList<Card> getSupriseCards() {
        return supriseCards;
    }

    public LinkedList<Card> getWarrantCards() {
        return warrantCards;
    }
